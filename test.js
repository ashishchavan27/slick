...
const numTransactions = 1000; // 10 million
...
const insertStatement = `INSERT INTO public.transactions ("TransactionID", "UserID", "Amount", "Timestamp") VALUES (${transaction.TransactionID}, '${transaction.UserID}', ${transaction.Amount}, '${transaction.Timestamp}');\n`;
